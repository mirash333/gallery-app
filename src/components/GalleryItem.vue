<template>
    <router-link :to="{name: 'PhotoCard' ,params: {
        image: this.image,
        id: this.image.id
    }}">
        <div class="gallery-item col-span-1 bg-gray-100 shadow-md " ref="galleryItem">
            <div class="gallery-item__image">
                <v-lazy-image :class="{'invisible': !isImageLoaded}" class="transition duration-300" :src="image.urls.regular" :alt="image.alt_description" @intersect="draw({ref: 'galleryItem'})" @load="isImageLoaded = true"  />
